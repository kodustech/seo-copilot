...
function latestRowFrom(
  ...
  return {
    ...
    prs_reviewed_30d: org.prsReviewed30d,
    suggestions_30d: org.suggestions30d,
    suggestions_implemented_30d: org.suggestionsImplemented30d,
    suggestions_partial_30d: org.suggestionsPartial30d,
    tier: cls.tier,
    trigger: cls.trigger,
    health: cls.health,
